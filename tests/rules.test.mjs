...
const SISALTO_VALMIS = new Set(['maailma', 'africa', 'europe', 'suomi', 'istanbul', 'asia', 'oceania']);
...
// paketit 4 ja 5).
const VOICES_DONE = new Set(['maailma', 'africa', 'suomi', 'istanbul', 'asia', 'europe', 'oceania']);
