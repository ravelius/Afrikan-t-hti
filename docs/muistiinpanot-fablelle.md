...
| v | Muutos |
|---|---|
| 184 | **Kuvakortti keskelle ruutua.** Omistaja edellisen version jälkeen: *"Ei keskellä."* Kortti valui oikealle yli ruudun reunan. **Vaakakeskitys laskettiin JavaScriptissä oletuksella, että kortti on korkeintaan 400 pikseliä leveä** — ja kun kortti kasvoi isolla ruudulla 720 pikseliin, laskelma jäi vanhaksi. Sama virhe oli aiemmin pystysuunnassa ja korjattiin silloin siirtämällä keskitys CSS:ään; nyt myös vaaka. **Opetus: kun mitta muuttuu tyylitiedostossa, jokainen JavaScriptissä oleva oletus samasta mitasta on rikki. Oikea korjaus ei ole päivittää lukua vaan poistaa oletus.** |
| 183 | **Kuvapino kestää useamman kuin kaksi kuvaa.** Omistajan toive: *"Matkakirjassa mainitut näkymät ja asiat olisi kiva saada kuvin matkakirjan kuviin, joita voi siis olla enemmän kuin kaksi."* Päiväkirja mainitsee Suakinissa korallitalot, sataman ja dhow-veneet, mutta kortissa oli tilaa vain vanhalle ja uudelle kuvalle. Uusi kenttä `lisat` on lista kuvia niiden väliin, ja järjestys kertoo saman tarinan kuin teksti: vanha valokuva, tekstin mainitsemat näkymät, viimeisenä nykypäivä — pino päättyy siihen mitä paikasta on jäljellä. **Napautus kiertää eteenpäin eikä vaihda päikseen:** kahdella kuvalla vaihto riitti, useammalla se olisi jättänyt loput näkymättömiin. Laskuri kertoo montako kuvia on, koska alta pilkottava reuna riitti vihjeeksi vain kahdella. Vanhat tietueet toimivat ennallaan. |
| 182 | **Kuvakortti isommaksi isolla ruudulla.** Omistajan toive iPadilta: *"Nämä kuvat voisi näkyä isompana."* Leveyskatto 460 px oli mitoitettu puhelimelle, ja tabletilla kortti jäi ruudun keskelle pieneksi lapuksi vaikka tilaa oli runsaasti. iPadilla nyt 720 px ja kuva 554 px korkea (ennen 460/330). **Kasvatus rajattiin leveisiin ruutuihin, ja se oli tarpeen:** ensimmäinen yritys kasvatti kaikkia, ja puhelimella kuvasta tuli korkeampi kuin kortti leveä — vaakakuvan postikortti muuttui pystykortiksi. Kortissa on kuvan lisäksi kuvateksti, joten korkeutta ei voi kasvattaa vapaasti. Raja 700 px on sama kuin muuallakin pelissä. |
| 181 | **Lasit omalle välilehdelleen.** Omistaja: *"Neljä ylintä tässä ovat aarteiden (erikoislasit) toiminnallisuuksia, ei peli-ideoita."* Havainto on oikea ja ero olennainen: animoitu historiakartta, ihmisen leviäminen, lämpökartat ja museokuva **eivät ole minipelejä** — niissä ei ole kysymystä, vastausta eikä palkintoa. Ne ovat kerroksia kartan päällä: kartta pysyy paikallaan ja lasien läpi katsottaessa sen päälle piirtyy jotain, mitä paljaalla silmällä ei näe. Ne jakavat saman koneiston keskenään mutta eivät minkään minipelin kanssa, ja väärässä listassa ne olisivat vieneet suunnittelun väärille urille. Peli-ideoita jäi 23. **Kirjattu myös uusi toimeksianto:** peli-ideat toteutetaan niihin kaupunkeihin jotka ovat työn alla (Aasia ja Lähi-itä), museokokoelmia ja muita avoimia lähteitä käyttäen. Kevyimmät ensin, koska aineisto on jo pelissä: kielitunnistus (31 näytettä), lipputunnistus (83 lippua), valokuvan paikannus. Sääntö kaikille: aineisto haetaan etukäteen pelipaketteihin eikä lennossa — muuten tehtävä jää tulematta juuri silloin kun peliä eniten pelataan, yhteydettömänä. |
| 180 | **Noppa palasi ja 53 kaupunkia sai maan.** Omistaja: *"Noppa-animaatio puuttuu kokonaan."* Syy oli yhdistetyn laudan koristetiedoissa: **`decor.dieSpot` puuttui**, ja ilman sitä nopan sijoitus kaatuu eikä noppaa näy lainkaan. Generaattori ei kirjoittanut kenttää, koska se ei ollut missään testissä eikä näy muualla. Nyt jokainen lauta tarkistetaan: dieSpot on olemassa ja sen arvot ovat osuuksia ruudusta. **Maatunnuksia 87 → 140/143.** Aiempi ajo oli hakenut ne, mutta työkalu ylikirjoitti tulostiedoston joka ajolla, joten vain viimeisen kierroksen kymmenen säilyi — hiljainen tiedonhukka, ei virheilmoitusta. Kolme jäi ilman: Jekaterinburg ja Jakutsk saavat tunnuksen käsin, mutta **Jerusalem jätetään tarkoituksella ilman** — Wikidatassa sillä ei ole sijaintimaata, ja periaate 3 sanoo että kiistanalaiset kaupungit kuvataan toteavasti molempien osapuolten olemassaolo tunnustaen. Tyhjä kenttä on rehellisempi kuin valinta. |
| 179 | **Periaate 2b: paikka ennen lajia — ja se toteutettiin myös koodissa.** Omistajan linjaus: *"Koita hakea aina kaupunkikohtainen ääni tai ainakin maa jos muuten ei löydy. Vasta sitten kategoria kohtainen."* Kirjattu periaatteisiin omaksi kohdakseen: ääni ja kuva haetaan niin läheltä kuin mahdollista — kaupungista, sitten maasta, vasta sitten lajista. **Perustelu on periaatteessa 3:** sama basaarinauha Marrakechissa, Isfahanissa ja Bagdadissa kertoo pelaajalle että paikat ovat vaihtokelpoisia, ja jokainen paikka pitää kuvata omana itsenään. Marrakechin tori ei kuulosta Isfahanin torilta, ja juuri se ero on osa sitä mitä peli opettaa. **Koodissa portaita oli kaksi**, kaupunki ja laji; nyt kolme. Maakori kokoaa saman maan muiden kaupunkien äänitykset `cityCountry`-kartasta — uutta aineistoa ei tarvittu, vain uusi porras. |
| 178 | **Perustiedot 66 kaupungille: wiki, ambienssi ja maa.** Aasian ja Lähi-idän kaupungeilta puuttui kaikki kolme — myös alkuperäisiltä laudoilta — joten kuvia ei voinut hakea eikä kaupunki soinut. Nyt kaikilla 143:lla on wiki ja ambienssi, maatunnuksia 87. **Kolme virhettä, sama opetus.** (1) Ensimmäinen ajo ilmoitti 46 kaupunkia löytymättömiksi, mukaan lukien Tokion ja Delhin: Wikipedia vastasi 429 ja työkalu tulosti sen puuttuvana artikkelina — hiljainen nieleminen teki verkkovirheestä sisältövirheen. (2) Hidastus oli väärä korjaus; oikea oli NIPUTTAA kyselyt, koska MediaWiki ottaa 50 nimeä yhdellä pyynnöllä ja Wikidata 50 tunnusta. Ajo lyheni viidestä minuutista sekunteihin, eikä rajaa tarvitse kiertää lainkaan. (3) Kirjoitussuodatin hyväksyi vain aaltosulkeella alkavat rivit, mutta aloituskaupungit ovat monirivisiä — Tokio, Peking, Istanbul ja Kairo jäivät täydentämättä ja ajo ilmoitti onnistuneensa. **Yhteinen opetus: työkalu joka ei erota "ei löytynyt" ja "ei kysytty" -tapauksia valehtelee onnistumisesta.** Käsin päätetty: ambienssi (makuasia — Bagdad basaari, Jakutsk pohjoinen, Borneo sademetsä; arolle ei ole omaa ääntä joten Astana ja Ulan Bator saavat savannin), kolme poikkeavaa otsikkoa (Soul on täsmennyssivu, Kamtšatka on niemimaa, Petra on etunimi) ja Singaporen sekä Hongkongin maatunnus, joita Wikidata ei anna. |
| 177 | **Napsahdus lopusta pois — ja "ei kaikissa" oli ratkaiseva vihje.** Omistaja v176:n jälkeen: *"Joissain kuuluu napsahdus vielä lopussa mutta ei kaikissa."* Se sulkee pois sen ettei häivytystä ajettaisi lainkaan; silloin napsahtaisi joka kerta. **Voimakkuutta säädetään ruudunpäivityksen tahdissa eli ~16 ms välein**, joten kun häivytys päättyi vasta tiedoston lopussa, viimeinen säätö osui pahimmillaan kolmasosaan täydestä voimakkuudesta. Äänitteet jotka loppuvat jo valmiiksi hiljaisuuteen eivät napsahtaneet — siitä ero. Häivytys on nyt 120 ms ja saavuttaa nollan 25 ms ennen loppua; pysäytys osuu hiljaisuuteen. 25 millisekuntiin ei mahdu tavua, joten viimeinen sana kuuluu yhä kokonaan. **Opetus: kun vika esiintyy vain osassa tapauksista, ero tapausten välillä on itse diagnoosi** — tässä se erotti "häivytys ei toimi" -selityksen "häivytys ei ehdi loppuun" -selityksestä. |
| 176 | **Lukijan viimeinen sana kuuluu taas.** Omistaja: *"Lukijan ääni feidautuu pois ja nielee viimeisen sanan. Feidi saisi olla ihan viimeinen millisekunti jotta napsahdus lopusta vain jää pois."* **Sama luku palveli kahta eri tarkoitusta.** Puolitoista sekuntia on oikea silloin kun luenta katkaistaan KESKEN tiedoston lauserajalla — siellä häivytys korvaa töksähtävän katkon keskellä puhetta, ja se lisättiin aikanaan juuri omistajan havainnon perusteella. Nauhoituksen omassa lopussa sama pituus alkoi puolitoista sekuntia ennen loppua eli keskellä viimeistä sanaa. Pahensi vielä toinen kohta: soitin pysäytettiin kun loppuun oli 50 ms, joten loppu syötiin kahdesti. Nyt lukuja on kaksi: lauseraja 1,5 s, loppu 0,05 s, eikä ääntä pysäytetä ennen tiedoston loppua. **Opetus: kun yksi vakio palvelee kahta eri tarkoitusta, se on oikea korkeintaan toiseen.** Kommentti väitti vielä nimenomaisesti ettei viimeinen sana huku — väite oli kirjoitettu lauserajaa ajatellen ja jäi voimaan väärässä paikassa. |
| 175 | **Neljä pudonnutta saarta takaisin ja Tutki-nappi luettavaksi.** Omistaja: *"Korsika puuttuu"* ja *"Tutki nappi näkyy huonosti"*. **Rannikoiden karsinta pudottaa pienet renkaat ja säästää vain ne, joiden sisällä on kaupunki** — Sisilia, Kreeta, Kypros ja Sansibar jäivät, Korsika ja Sardinia eivät. Kaupungittomuus on väärä mittapuu saaren olemassaololle. Haku paljasti kaksi muutakin, ja ne olivat pahempia kuin omistaja ehti mainita: **Islannin ja Saint Helenan kaupungit kelluivat aavalla merellä ilman saarta.** Uusi `tools/puuttuvat-saaret.mjs` kääntää vanhojen lautojen omat rannikot takaisin lon/lat:ksi ja projisoi Milleriin (sama sovitus kuin maiden rajoissa), ja lisää vain sen mitä laudalta puuttuu — olemassa olevan ääriviivan peittämään kohtaan ei kosketa. Rannikoiden uudelleenlaskenta olisi vaatinut Natural Earthin aineiston; sama tieto oli jo pelissä. **Kaksi merireittiä piti laskea uudelleen:** Barcelona–Rooma kulki Sardinian yli ja Islanti–Tromssa Islannin yli, koska maata ei ennen ollut siinä. **Tutki-napin tyylissä luki `background: none`**, joten kartta näkyi napin läpi ja teksti hukkui kaupunkinimiin. Ajatus oli oikea (ensisijainen erottuu kullalla eikä kultalaatalla), mutta se vei myös pergamenttilevyn jonka muut napit saivat juuri luettavuuden vuoksi. Nyt levy on ensisijaisellakin, lämpimämpänä ja peittävämpänä. |
| 174 | **Matkakertoja takaisin yhdistetylle laudalle.** Omistaja: *"Matkakirjan lukija ääni puuttuu kaikkialta. Myös äänen symboli puuttuu matkakirjasta."* **Sama juurisyy kuin Tutki-ikkunassa, eri paikassa:** luennat on avainnettu `lauta:kaupunki` ja tiedoston nimessä on sama laudan tunnus (`puhe-europe-saapuminen-dubrovnik.mp3`), eikä yhdistetylle laudalle ole yhtään luentaa — eikä tulekaan, koska kyse on samoista kaupungeista ja samoista nauhoituksista. Kaiutinnappi näytetään vain kun luenta löytyy, joten myös symboli katosi: oikea käytös väärästä tiedosta. Uusi `luentaLauta()` käy lähdelaudat läpi ja palauttaa sen jolta luenta löytyy; tunnusta käytetään sekä listahaussa että tiedostonimessä, ja kaikki kolme luentalajia (saapuminen, havainto, aarrevihje) kulkevat saman haun kautta. **Opetus: yhdistetty lauta perii sisältönsä, mutta jokainen laudan tunnuksella tehty haku on oma erillinen kohtansa.** Niitä oli viisi sisältötaulua ja kaksi karttakenttää (v173) ja kolme luentalistaa (v174). Seuraava joka lisää tällaisen haun lisää samalla uuden vian — siksi haku on nyt yhdessä funktiossa eikä kolmessa kohdassa. |
| 173 | **Tutki-ikkuna täydeksi yhdistetyllä laudalla.** Omistaja: *"iPadilla tutki ikkuna on vajaa"* ja tarkennus *"Tutki ei näy oikein iPhonellakaan."* **Tarkennus ratkaisi asian:** kun sama vika on molemmilla laitteilla, syy ei ole näytössä vaan sisällössä. Tutki-ikkunan oikea palsta (maan nimi, lippu, minikartta, tunnusluvut, tervehdykset) ja Kaupungin elämää -osio haetaan LAUDAN TUNNUKSELLA, eikä yhdistetylle laudalle ollut mitään: viisi sisältötaulua tunsivat vain `africa` ja `europe`, ja `map.cityCountry` ja `map.countryShapes` puuttuivat paketista kokonaan. Kaupungin kuva ja tiivistelmä tulevat Wikipediasta ja näkyivät, joten ikkuna avautui — vajaana. **Korjaus kahdessa osassa:** (1) `SAAPUMISTEKSTIT`, `KULTTUURIT`, `VALOKUVAT`, `KIELET` ja `MAATIEDOT` saivat `vanhamaailma`-rivin, joka yhdistää lähdelautojen taulut — turvallista, koska avaimet ovat kaupunkitunnuksia ja porttikaupungit ovat yhtenä kappaleena. (2) Uusi `tools/maat-vanhaanmaailmaan.mjs` kääntää Euroopan ja Afrikan maiden rajat takaisin lon/lat:ksi ja projisoi Milleriin: 79 kaupunkia, 56 maata, 74 rengasta. **Millerin sovitus luetaan laudalta itseltään** pienimmän neliösumman sovituksella, joten työkalu ei tarvitse Natural Earthin aineistoa eikä voi ajautua eri mittakaavaan kuin lauta. **Sovitus piti tehdä kolmesti:** kaupunkien paikat eivät ole puhdasta projektiota (rannikkokaupungit on siirretty maalle, kaksi satamaa erikseen rannalle), joten suora sovitus kaatui — nyt huonoin viidennes pudotetaan joka kierroksella, mediaanipoikkeama 0,0 ja pahin 68 yksikköä, ja pahin on siirretty kaupunki eikä virhe. **Leveys lasketaan projisoiduista renkaista** eikä skaalata vanhasta luvusta, koska lähdelaudoilla on eri mittakaavat. Jäljellä: Aasialla ja Lähi-idällä ei ole maarajoja omilla laudoillaankaan. |
| 172 | **Lento ei tökkää, ja puheen virhe kirjoitetaan näkyviin.** Omistaja: *"Lento tökki, mutta kartta toimii. Matkakirjan ääni ei kuulu iPadilla."* **Hitaus oli siirtynyt lennon kohdalle:** lauta piirretään kalvon taakse jo lennon aikana, ja bittikartan rasterointi vie satoja millisekunteja pääsäikeessä. Kartta oli nopea, koska sen työ oli tehty — se vain tehtiin väärään aikaan. Rasterointi odottaa nyt kalvon väistymistä. **Sama jumi selittää todennäköisesti myös puheen:** lennon puhe alkaa 1400 ms:n ajastimella, eikä ajastin pääse ajoon jumin läpi, ja iOS hylkää `play()`-kutsun joka ei enää liity käyttäjän eleeseen. **Tämä on arvaus enkä voi toistaa iPadia täällä**, joten `play()`-kutsun virhe kirjoitetaan nyt konsoliin virhenimineen sen sijaan että se nieltäisiin vaieten — `NotAllowedError` erottuu latausvirheestä. **Yleinen opetus: nopeusongelmaa ei riitä poistaa, se pitää poistaa oikeasta hetkestä.** Työ ei kadonnut mihinkään; se vain siirtyi kohtaan, jossa mittari ei sitä nähnyt. |
| 171 | **Bittikartta ruuduiksi, lataus vain sormen irrotessa, vinjetti pois.** Omistajan linjaus: *"Pitää olla sen verran bufferia että kesken eleen ei tarvitse ladata. Mutta heti kun sormi irtoaa ladataan lisää ja silloinkin vain uusi osa jotta itse lataus mahd. nopea"* ja tarkennus *"lataus siis aina vain juuri kun sormi irtoaa, ei muulloin."* **Miksi edellinen tökki:** kuva piirrettiin kokonaan uudestaan aina kun näkyvä alue lähestyi piirretyn reunaa, ja lataus alkoi KESKEN eleen. Rasterointi vie satoja millisekunteja pääsäikeessä, joten se tuntui nykäyksenä riippumatta siitä kuinka pieni pala oli uutta. **Kolme sääntöä:** (1) `asetaPan` ei enää tilaa mitään; (2) puskuria on ruudullisen verran joka suuntaan, mikä kattaa koko eleen, koska sormi ei mahdu kulkemaan ruutua pidemmälle; (3) kuva on ruudukko, jossa jo piirretyt ruudut jäävät paikalleen ja uutta työtä on vain näkyviin tullut kaistale. Lataus tapahtuu `pointerup`/`pointercancel`-hetkellä ja näkymän asettuessa. **Nopeuden kannalta olennaisin yksityiskohta:** taide sarjallistetaan KERRAN. Jos se tehtäisiin joka ruudulle, 6500 elementin läpikäynti maksaisi enemmän kuin itse piirto. **Tarkkuus budjetista:** iPadin näyttö on kaksinkertainen, joten logiikkapikseleillä piirretty kuva pehmenee ja ohuet rantaviivat katoavat; tarkkuus maksaa muistia neliöllisesti ja puskuroitua aluetta on yhdeksän ruudullista, joten tarkkuus valitaan 48 megatavun budjetista — niin tarkka kuin mahtuu, enintään näytön oma. **Vinjetti poistettu kaikkialta** (omistajan päätös): reunahäivytys rajasi lautaa kuin vanhan filmin ruudun silloin kun kartta oli kiinteä kokonäkymä, mutta nyt karttaa panoroidaan joka laudalla eikä reuna rajaa mitään — se vain haalistaa sitä osaa karttaa jota katsotaan. Poistettu sekä CSS:stä että kartan omasta piirrosta. |
| 170 | **Kartan kuva ei enää välky eikä jää jälkeen.** Omistajan kaksi kysymystä: *"Lasketaanhan uusi bittikartta heti kun sormi irtoaa eikä vasta kun uusi sormiele alkaa?"* ja *"Kuva välkkyy kun se tekee uuden latauksen siirron aikana."* **Ensimmäiseen: kyllä, ja jopa aikaisemmin** — uusi kuva pyydetään jo kesken pyyhkäisyn, koska jokainen sormen liike tarkistaa onko näkyvä alue tullut puolen ruudun päähän piirretyn reunasta. **Mutta yksi aukko oli:** jos piirto oli kesken juuri kun sormi nousi, seuraava tarkistus tuli vasta seuraavasta eleestä, ja siinä välissä kuva oli jo väärässä kohdassa. Eleen päättyminen sai oman tarkistuksensa. Kuva tarkistetaan nyt kolmena hetkenä — liikkeen aikana, eleen päättyessä ja näkymän asettuessa — eikä yksikään riitä yksin; testi vartioi kaikkia kolmea. **Välkkymisellä oli kaksi syytä.** (1) PNG:tä ei ollut purettu: SVG:n `<image>` viittaa blob-osoitteeseen, jonka selain hakee ja purkaa vasta kun elementti on puussa, ja siinä välissä ehtii yksi tyhjä kehys. Nyt kuva puretaan valmiiksi (`decode()`) ennen puuhun panoa. (2) `replaceChildren` poistaa vanhan ja lisää uuden samalla kertaa, eikä uusi ole vielä piirtynyt — nyt uusi menee vanhan ALLE ja vanha poistetaan vasta seuraavalla kehyksellä, jolloin ruudulla on koko ajan jompikumpi. **Yleinen opetus: kuvan vaihtaminen ei ole atominen tapahtuma, vaikka DOM-kutsu on.** |
| 169 | **Tiet takaisin kartalle, ja kuvasta tehtiin oikea bittikartta.** Omistajan kuvakaappaus iPadilta: *"Lataa edelleen liian laajan näkymän alkuun. Tiet eivät näy vaikka zoomaan lähemmäs ja skrollaus tökkii."* **Tiet katosivat samasta syystä kuin meri v159:ssä.** Reittikerros oli kartan viimeinen suodatettu kerros. v159:ssä poistin `#rough`n mantereilta, aalloilta ja maastolta, koska iOS palautti suodatetun kerroksen tyhjänä, mutta jätin reiteille `#rough-soft`in — ja perustelin sen sillä, että kerros on pieni ja näkyi omistajan kuvassa oikein. **Perustelu oli tosi silloin ja vanhentui kun lauta seitsenkertaistui:** reittikerros ulottuu nyt Lissabonista Tokioon. Heilunta piirretään pisteisiin kuten rannikoilla, `#rough-soft` on poistettu, ja kartalla ei ole enää yhtään suodatinta; testi vartioi ettei kartan kerrokselle voi lisätä `filter`-määrettä. **Toinen löytö: SVG-kuva ei ole bittikartta.** v167:ssä annoin `<image>`-elementille SVG-blobin osoitteen. Elementtimäärä laski ja mittari näytti 26 ms — mutta kun siirsin reitit samaan kuvaan, panorointi hidastui **128 millisekuntiin**. SVG-kuva on yhä vektoria: selain piirsi sen uudelleen aina kun muunnos muuttui, joten olin vain siirtänyt työn toiseen paikkaan. Nyt kuva piirretään canvakselle ja käytetään PNG:nä. **Mittarit: 7192 elementtiä ja 236 ms → 805 elementtiä ja 17 ms.** Puskuri pienennettiin kokonaisesta ruudullisesta 0,6:een, koska kolme kertaa ruudun levyinen canvas on iPadilla yli 40 megatavua. Saapumisnäkymän yläraja 2400 → 1500 yksikköä, mikä osuu portaalle 1422 eli noin kolmeenkymmeneen pituusasteeseen. |
| 168 | **Saapumiszoom vie mantereeseen eikä kaupunkiin, ja isolla laudalla kokonäkymä jää väliin.** Omistajan havainto iPadilta: *"Vanha maailma näkyy kokonaan ja zoomautuu sen jälkeen aivan liian lähelle Ateenaa. Pitäisi näkyä vain Eurooppa ja sitten jäädä siihen."* **v167:n korjaus oli puolittainen:** vaihdoin portaat kertoimista kiinteiksi näkyviksi leveyksiksi `[667, 435, 294, 200, 132, 88]`, mikä korjasi lähimmän portaan mutta rikkoi toisen pään — tihein porras 667 yksikköä on tuhannen yksikön laudalla sopiva ensiaskel, mutta 7200:n laudalla jo kaupungin ympäristö, joten kokonäkymän ja ensimmäisen portaan väliin jäi **yli kymmenkertainen hyppy**. **Opetus: kun luku toimii yhdellä laudalla ja rikkoutuu toisella, vika on siinä että luku on absoluuttinen.** Nyt portaat lasketaan laudan leveydestä puolitoistakertaisin askelin (1000 → 667, 444, 296, 198, 132, 88; 7200 → 4800, 3200, 2133, 1422, 948, …), jolloin pieni lauta käyttäytyy kuten alkuperäiset kertoimet ja isolle syntyy portaita väliin itsestään. **Saapumistaso lasketaan eikä numeroida:** kiinteä porrasnumero olisi pienellä laudalla lähikuva ja isolla yleisnäkymä, joten valitaan porras joka on lähimpänä 43 %:a laudasta (sama osuus kuin vanha MANNER_ZOOM 2.3), enintään 2400 yksikköä — pieni lauta saapuu 444 yksikköön kuten ennen, yhdistetty 2133:een eli Lissabonista Moskovaan. **Kokonäkymä jätetään isolla laudalla kokonaan väliin:** saapumisliuku alkaa siitä, ja se oli havainnon ensimmäinen puolisko. Pienellä laudalla liuku on hyvä, koska kokonäkymä kertoo minne on tultu; vanhalla maailmalla se ei kerro. |
| 167 | **Kartan taide bittikartaksi ikkuna kerrallaan, ja zoomi laudan koon mukaan.** Omistaja: *"Kartan scrollaus on hidas eikä zoomaa tarpeeksi lähelle."* **Mitattiin ensin** (`tools/mittaa-kartta.mjs`): Eurooppa 741 elementtiä ja 30 ms/kehys, vanha maailma **7192 elementtiä ja 236 ms/kehys** — noin neljä kuvaa sekunnissa. **Koodin oma kommentti valehteli:** se lupasi, että CSS-muunnoksella panoroitaessa selain käyttää valmista rasteria. Ei käytä. Omistaja arvasi sen itse: *"onhan se bittikarttana kun scrollataan?"* Nyt kartan muuttumaton taide (pergamentti, mantereet, aallot, maasto, koristeet) on yksi kuva ja elävään puuhun jää vain se mikä muuttuu: **7192 → 1611 elementtiä, 236 → 25 ms/kehys**, sama kuin pienellä laudalla. **Ikkuna eikä koko kartta** (omistajan tarkennus): yhdistetyn laudan pergamentti on ~26 000 yksikköä leveä, joten kuva tehdään alueesta joka on ruudullisen verran näkyvää suurempi joka suuntaan, ja uusi tilataan jo puolen ruudun päässä reunasta — vanha jää paikalleen kunnes uusi on ladattu, joten tyhjää ei näy koskaan. **Kolme omaa virhettä, ja kaikki näkyivät VAIN kuvakaappauksessa:** (1) irrallinen SVG ei peri sivun tyylejä, koska säännöt on kirjoitettu sivun rakennetta vasten (`#board`, `body...`) eikä siinä ole bodya — kartasta tuli musta paperi mustine mantereineen; nyt jokaisen elementin LASKETTU tyyli kirjoitetaan klooniin kiinni. (2) Ikkuna rajataan paperin sisään, joten kartan laidalla ehto "puskuria joka suuntaan" ei voi täyttyä — ikuinen silmukka. (3) Ensimmäinen kuva piirtyi ennen kuin viewBox oli asettunut, jolloin ikkunaksi tuli 3000 yksikköä, eikä yleiskuvassa panoroida — mikään ei pyytänyt parempaa. **Opetus: mittari näytti koko ajan hyvää 26 millisekuntia, koska tyhjää karttaa on nopea piirtää.** Nopeusmittaus ei kelpaa oikeellisuuden todisteeksi; vertailukuva ennen/jälkeen on ainoa tapa nähdä tällainen. **Zoomiportaat olivat kertoimia kokonäkymään** (`[1, 1.5, 2.3, 3.4, 5]`), jolloin sama nappi tarkoitti eri asiaa eri laudalla: tuhannen yksikön laudalla suurin porras näytti 200 yksikköä, 7200:n laudalla 1440. Nyt portaat ovat **näkyviä leveyksiä** `[667, 435, 294, 200, 132, 88]` — samat luvut kuin vanhat kertoimet pienellä laudalla, plus kaksi uutta lähemmäs. **Isolla laudalla laskeudutaan suoraan lähikuvaan** (omistajan toive): kokonäkymä on olemassa siksi, että pelaaja näkee minne on tullut, eikä koko vanha maailma kerro sitä. |
| — | **Kolme uutta karttakerrosideaa kirjattu työhuoneeseen.** Omistajan ideat: (1) animoitu historiakartta, jossa kartta pysyy paikallaan ja päällä oleva kerros elää vuosilukujen mukana — ensimmäisenä Silkkitie, ja taikalasit voisivat olla juuri se väline jolla historialliset kartat näkee; (2) ihmisen leviäminen Afrikasta; (3) onnellisuusindeksi lämpökarttana ja sen muunnelmat (asukasluku, bruttokansantuote, elinikä, veroprosentti). **Mitä animoitu kartta vaatii:** vähemmän kuin miltä kuulostaa. Kartta on jo vektoria, ja pelin oma projektio kääntää lon/lat laudan koordinaateiksi — sama kaava jolla neljä lautaa yhdistettiin. Kerros on lista pisteitä ja vuosilukuja, ja aikajana valitsee mitkä näkyvät. Työläin osa on AINEISTO, ei tekniikka. **Yksi varaus kirjattava peliin asti:** mitä kauemmas ajassa mennään, sitä epävarmempia rajat ovat, ja se pitää sanoa pelaajalle ääneen — muuten peli opettaa arvauksia faktoina. Lämpökartat ovat näistä helpoin: aineisto on avointa ja maakohtaista, ja peli tuntee jo maiden rajat. |
| 166 | **Vanha maailma on kytketty peliin, ja kaikki 54 merireittiä kulkevat vettä pitkin.** Omistaja: *"Julkaise kartta sitten suoraan peliin kun saat nuo valmiiksi"*, *"aina voi peruuttaa jos ei toimi"*, *"pelillä ei ole vielä pelaajia niin voidaan edetä rohkeasti"*. Maailmankartan portit (Lontoo, Kairo, Mumbai, Peking, Tokio, Singapore, Moskova, Ateena, Kapkaupunki, Tanger) vievät nyt ensisijaisesti yhdistetylle laudalle; neljä alkuperäistä jäävät rinnalle, koska niillä on kullakin oma aarteensa. **Kolme korjausta, ja jokaisessa syy oli eri kuin luulin.** (1) *Mittatikku oli väärä.* Kirjasin v165:ssa, että 13 reittiä kulkee maalla liian karkean ruudukon takia. Ruudukko oli tehnyt työnsä — jokaisessa maalla kulkevassa reitissä KAIKKI välipisteet olivat vedessä. Työkalu tarkisti suoria pätkiä, mutta peli pehmentää välipisteet Catmull-Rom-käyräksi, ja käyrä kaartaa jyrkissä mutkissa pisteiden ULKOPUOLELLE. Kelpuutus rakentaa nyt saman viivan kuin peli. (2) *Oma virhe kiinni omasta tarkistuksesta:* ensimmäinen korjattu versio ilmoitti kaikki reitit korjatuiksi ja oli vain poistanut niiden välipisteet — uusi kelpuutus katsoi vain viivan kulmapisteitä, ja välipisteettömällä suoralla niitä on kaksi, molemmat satamassa, joten tarkastettavaa ei jäänyt. Näytteet otetaan nyt viivaa pitkin. Ja väli piti tihentää neljästä yhteen yksikköön: Helsingin ja Tallinnan väli on 112 yksikköä, eli satamavyöhykkeiden (55+55) väliin jää vain 2,2 yksikköä — neljän askel hyppäsi sen yli. **Kapeimmat tarkastettavat kohdat ovat lyhyillä reiteillä, eivät pitkillä.** (3) *Madagaskarin kolme reittiä eivät olleet reittiongelma lainkaan:* kaupunki oli 72 yksikön päässä rannasta, ja peli sallii satamapätkäksi 55 — mikään haku ei olisi voinut kelvata. `tools/satamat-rannalle.mjs` siirsi Madagaskarin ja Mosambikin rannan tuntumaan; kynnys (46) ja tavoite (26) ovat eri luvut tahallaan, koska ensimmäinen versio olisi siirtänyt kahdeksan kaupunkia mukaan lukien Kairon. **Nopeus:** vesirasteri lasketaan riveittäin eikä ruutu kerrallaan (6700 ruutua 5,1 s → 0,33 s) ja tarkistetaan otoksella pelin omaa `isOnLand`ia vasten, ettei oma toteutus eriydy huomaamatta; A*:n avoin lista kekoon. Pelin puolelle jäi pysyvä parannus: **ääriviivan rajauslaatikko muistetaan** (`js/mapart.js`), joten kaukainen rannikko hylätään neljällä vertailulla — se nopeuttaa myös kartan piirtoa isolla laudalla. **Testit vaativat myös korjausta:** ne valitsivat portin kiinteällä indeksillä 0, ja kun yhdistetty lauta nousi kärkeen, neljä hajosi; nyt testi sanoo minkä laudan se haluaa. 369 testiä läpi, 0 ohitettua. Jäljellä: aarrelogiikka (yksi per maanosa), paluu Lontooseen, 80 päivää. |
| 165 | **Vanha maailma on nyt lauta, jonka peli osaa piirtää** (omistaja: "Kartta loppuun"). `js/packs/vanhamaailma.js`: 7200×2620, 143 kaupunkia, 222 reittiä, 38 rannikkoa, 17 saarta; nähtävissä `?lauta=vanhamaailma`. Se **ei korvaa neljää nykyistä lautaa** — Lontoosta on linkki molempiin, kunnes pelilogiikka on valmis. **Lauta levisi 4000 → 7200,** koska ensimmäinen ajo pudotti 18 kaupunkia (Praha, Budapest, Mekka, Riika…) pelin minimietäisyyden takia; kaupunkien poistaminen olisi ollut väärä korjaus, ja zoomi tekee koosta merkityksettömän. **Merireitit piti laskea uudelleen:** vanhoilla laudoilla suora viiva riitti, koska rannikko oli karkea, mutta Natural Earthin tarkalla rannikolla 50 reittiä 54:stä kulki maan yli. Nyt A* vesiruudukon läpi (ruutu 12; 22 umpeutti Englannin kanaalin, kun rannikon viereiset ruudut merkitään maaksi). **Pahin ansa: pelkistys pilasi lähes kaikki lasketut reitit** — A* löysi kunnollisen polun ja Douglas–Peucker oikaisi sen takaisin mantereen läpi juuri siellä missä reitti kiertää niemen; siksi jokainen pelkistys tarkistetaan vettä vasten ennen hyväksyntää. **13 merireittiä 54:stä kulkee yhä maan yli** — kapeita salmia ja saaristoja, joissa 12 yksikön ruutu sulkeutuu maan levityksen jälkeen (Tukholma–Helsinki, Lontoo–Dublin, Mekka–Aden…). Testi ohittaa ne nimeltä (`MERIREITIT_KESKEN`), ei hyväksy hiljaisesti. **Pergamentti oli kiinteän kokoinen** (`PAPER` vakiona 3600×3600), joten leveällä laudalla meri jäi mustaksi puolivälistä eteenpäin; nyt `paperi(map)` laskee koon laudasta ja vanhat laudat tarkistettiin erikseen. **Sisältöä ei kopioitu** — generaattori tuo kysymykset ja kuvat neljästä lähdepaketista ja karsii kaksoiskappaleet koko laudan tasolla niin, että kaupungin oma kori voittaa yleiskorin. Tekemättä: 13 reittiä, pelilogiikka (neljä aarretta, paluu Lontooseen, 80 päivää), porttikaupunkien sisällöt ja suorituskyky iPadilla. |
| — | **Minipelien tärkein suunta päätetty: museokuvat, sidottuna kaupunkiin.** Omistaja: *"Paras idea on käyttää museoiden yms kuvia tehtävissä. Olisi kiva että tehtävä liittyy kyseiseen kaupunkiin jossa ollaan."* Kirjattu työhuoneen minipelilistaan omaksi kortikseen. Lähteet ovat avoimia ja ilmaisia (Met, Smithsonian, Rijksmuseum, Europeana, Commons), ja kuvat kulkevat saman peilin läpi kuin muutkin, joten ne toimivat offline. **Aineisto haetaan etukäteen pelipaketteihin, ei lennossa** — muuten tehtävä jäisi tulematta yhteydettömänä, ja se on juuri se tilanne jossa peliä eniten pelataan. |
| — | **Pelin tavoite PÄÄTETTY, ja työhuoneeseen tuli Juoni-välilehti.** Omistaja: *"Pelin tavoite itse asiassa onkin selvillä. Se on löytää aarre jokaisesta maanosasta ja tulla lopuksi takaisin Lontooseen. Ja tehdä kaikki se alle kahdeksassakymmenessä päivässä."* Tämä **vastasi työlistan pitkään auki olleeseen kysymykseen**: 80 päivää ei ole lautakohtainen vertailuluku vaan YKSI matka — kuten `docs/tarina.md`:n ainoa päiväkirja vuodelta 1873, ja kuten pelaajahahmon nimi Fogg on aina vihjannut. Omistajan sanoin todellinen palkinto: *"pelaaja on oppinut ymmärtämään maailmaa paremmin"* — kokemukset ja työvälineet palvelevat sitä, eivät pisteitä. **Aarremalli: yksi per maanosa** (nykyiset neljä säilyvät tarinoineen). **Varusteet ja raha eivät ole maanosakohtaisia** — niitä saa eri paikoista riippumatta siitä missä ollaan. **Uusi vaatimus:** kaupunkitason laudoilla ajan pitää kulua hitaammin kuin mantereella, koska välimatkat ovat pieniä; se tekee pysähtymisestä kannattavaa aikarajasta huolimatta. `TURN_HOURS` ei siis voi olla yksi luku vaan lautakohtainen. Kaikki tämä on nyt työhuoneen **Juoni**-välilehdellä (tavoite, aarteet, kaupunkikartat, seitsemän varustetta tiloineen), koska omistaja pyysi ideat sinne luettaviksi. |
| — | **Aarre- ja varuste-ehdotukset kirjattu, ei toteutettu.** Omistajan linjaus: pelistä tehdään mahdollisimman erityyppinen Afrikan tähteen verrattuna, alkuun ei tarvitse palata, ja mukaan halutaan varusteita ("ne erikoissilmälasit ja niin edelleen"). Omistaja pyysi kirjaamaan ehdotukset ylös ja päättää aarteista myöhemmin. Ehdotukset ovat `docs/tyolista-opukselle.md`:n osiossa **PÄÄTTÄMÄTTÄ**. Ydinajatus: esineet ovat matkailijan varusteita jotka helpottavat matkaa ja oppimista, eivät jalokiviä jotka ovat pelkkää rahaa — ja ne tarttuvat pelin OMIIN järjestelmiin (tietovisa, päivät, passi, matkustustavat, kokemuspisteet). Toinen iso ero: **tyhjä laatta pois**, osa niistä varusteiksi, koska tyhjän laatan kääntäminen on Afrikan tähden turhauttavin piirre. Halvimmat toteuttaa ovat silmälasit ja suosituskirje, koska mekaniikka on jo olemassa maksullisena (`actionFiftyFifty`, `SEA_FARE`) ja varuste vain tekee siitä ilmaisen. Kauimpana Afrikan tähdestä on valokuvauskamera: se ei liity voittamiseen lainkaan. Aarteista suositukseni on yksi per maanosa — nykyiset neljä aarretta säilyvät tarinoineen. |
| 164 | **Taustataso +3 dB takaisin: -36 → -33 LUFS** (omistajan päätös kuuntelun jälkeen: "voit nostaa kolme desibeliä takaisin, ilmeisesti kompressointi ja muut hiljensivät sen verran jo muutenkin"). Havainto on oikea: kompressointi laskee huiput ja kertojan väistö hoitaa puhehetket, joten sama luku kuulostaa nyt hiljaisemmalta kuin ennen niitä — -33 ei ole enää sama kuin v162:n -33. Portaat kaikkiaan: -30 → -33 → -36 → -33. Hajonta pysyy 3,8 dB:ssä, koska tavoite siirtää kaikki 120 äänitettä yhdessä eikä muuta niiden keskinäisiä suhteita. |
| — | **Vanha maailma, vaiheet 2–3: reitit ja nimien paikat.** Omistajan linjaus: mittasuhteet realistisina, koska zoomi hoitaa koon. **Reittejä ei tarvinnut keksiä uusiksi** — samat kaupunkiparit ovat yhä naapureita, ja koska porttikaupungit (Istanbul, Kairo, Teheran) sulautuvat yhdeksi, neljä verkkoa liittyy niiden kohdalla itsestään: 143 kaupunkia ja 222 reittiä muodostavat YHDEN yhtenäisen verkon. 27 merireittiä kaartaa välipisteillä ja ne projisoitiin uudelleen, koska vanhoilla luvuilla ne kulkisivat maan yli. **Nimien paikoista arvioin väärin:** sanoin sen olevan "työn suurin erä, joka vaatii silmää eikä laskentaa". Se on kartografian vakio-ongelma ja ratkesi hakemalla — 12 ehdokaspaikkaa per nimi, törmäykset pisteytettynä (toinen nimi 100, kaupunkiympyrä 40, reitti 6). **Järjestys ratkaisee:** ahtaimmalla olevat ensin, muuten väljällä olevat veisivät parhaat paikat naapureiltaan. Tekstien leveydet mitataan selaimessa pelin omalla fontilla, koska merkkien laskeminen antaisi väärän tuloksen. **Tulos 143 nimeä, 0 päällekkäisyyttä**, käsin katsottavaksi ei jäänyt yhtään. |
| 163 | **Kertoja väistää nyt taustan, taso -36 LUFS ja kompressointi käytössä.** Omistaja: "Vieläkin on vaikea kuulla puhetta." **Oikea syy löytyi ennen nupin kääntämistä:** `vaimennaTausta()` laukesi vain ääninäytteestä ja zoomausäänestä — **kertoja ei väistänyt taustaa lainkaan**, joten tausta soi täydellä voimalla juuri silloin kun sen pitäisi väistyä eniten. Nyt `puheAlkoi()`/`puheLoppui()` laskurilla: laskuri tarvitaan, koska luentoja voi olla päällekkäin (saapumisteksti ja päiväkirja) eikä ensimmäisen loppuminen saa palauttaa taustaa kesken toisen. Väistön syvyys eriytettiin: näyte ja zoomausääni 0,15 (lyhyitä, saavat kadota), kertoja 0,25 (lukee minuutteja, tunnelma katoaisi mukana). **Taso -33 → -36 LUFS** omistajan pyynnöstä. **Kompressointi lisätty** (omistajan pyyntö): `DynamicsCompressorNode` taustavirtaan. **Kompressori on ENNEN voimakkuussäätöä** — jos se olisi jälkeen, kiinteä kynnys osuisi eri kohtaan joka äänitteellä, koska kertoimet vaihtelevat 0,15…6 eli 32 dB. Siksi soittimen volume jää ykköseen ja taso hoidetaan vahvistinsolmulla; sivuhyötynä vahvistin voi ylittää ykkösen toisin kuin HTML-volume. **Vaarallisin kohta:** Web Audioon reititetty elementti ei enää soi suoraan kaiuttimeen, joten pysähtynyt konteksti tai puuttuva CORS-lupa tuottaisi **täyden hiljaisuuden ilman virhettä**. Siksi reititys tehdään vain kun `ctx.state === 'running'`, ja `crossOrigin='anonymous'` asetetaan ennen srciä, jotta puuttuva lupa näkyy latausvirheenä — sille on oma varareittinsä, joka soittaa taustan puristamattomana. Molemmat lähteet tarkistettu: ämpäri sallii pelin osoitteen, archive.org kaikki. Todennettu selaimessa: 23,5 dB:n hyppy kesyyntyi 13,9:ään (−9,7 dB) ja **ääntä tulee**, ei hiljaisuutta. |
