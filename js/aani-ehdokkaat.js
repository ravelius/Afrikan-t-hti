...
export const TYYPPI_EHDOKKAAT = {
  basaari: [
    { url: 'https://cdn.freesound.org/previews/511/511005_571436-lq.mp3#voima=0.87', nimi: 'Basaarin hälinä (Khan el-Khalili) — 3bagbrew, CC0' },
    { url: 'https://cdn.freesound.org/previews/677/677253_9756914-lq.mp3#voima=0.33', nimi: 'Ouakamin piha illalla (Dakar) — LaureC, CC0' },
    { url: 'https://cdn.freesound.org/previews/677/677252_9756914-lq.mp3#voima=2.05', nimi: 'Ouakamin piha aamulla (Dakar) — LaureC, CC0' },
    { url: 'https://cdn.freesound.org/previews/683/683118_8105512-lq.mp3#voima=0.15', nimi: 'Katukauppiaat (Kairo) — AhmadAiuby, CC0' },
    { url: 'https://cdn.freesound.org/previews/723/723081_2978883-lq.mp3#voima=0.39', nimi: 'Kaupungin yö (Kairo) — rucisko, CC BY-NC' },
  ],
  aavikko: [
    { url: 'https://cdn.freesound.org/previews/714/714271_14696146-lq.mp3#voima=0.7', nimi: 'Aavikon äänimaisema — Metris, CC BY' },
    { url: 'https://cdn.freesound.org/previews/411/411774_1910728-lq.mp3#voima=4.14', nimi: 'Aavikon yön hiljaisuus — Diegolar, CC BY' },
    { url: 'https://cdn.freesound.org/previews/565/565015_12186594-lq.mp3#voima=0.15', nimi: 'Hiekkamyrsky — blackatomproductions, CC0' },
    { url: 'https://cdn.freesound.org/previews/438/438877_2524442-lq.mp3#voima=0.37', nimi: 'Hiekkamyrskyn tuuli — craigsmith, CC0' },
    { url: 'https://cdn.freesound.org/previews/635/635912_2247456-lq.mp3#voima=3.05', nimi: 'Kiuruja tuulisten dyynien yllä — Kinoton, CC0' },
    { url: 'https://cdn.freesound.org/previews/579/579250_2977885-lq.mp3#voima=0.19', nimi: 'Tuuli puissa — Danjocross, CC0' },
  ],
  meri: [
    { url: 'https://cdn.freesound.org/previews/635/635103_10065335-lq.mp3#voima=0.15', nimi: 'Tyyni aallokko — Eatyourburger, CC0' },
    { url: 'https://cdn.freesound.org/previews/848/848927_17398983-lq.mp3#voima=0.58', nimi: 'Rantatyrsky — Benson_Arizona, CC BY-NC' },
    { url: 'https://archive.org/download/aporee_8703_10524/CityCountryMeSassnitzFischereihafenFender.mp3#voima=0.24', nimi: 'Kalasatama (Sassnitz) — henrik schröder, CC BY-SA' },
    { url: 'https://cdn.freesound.org/previews/411/411509_1661766-lq.mp3#voima=0.15', nimi: 'Aallot lyövät kallioihin — felix.blume, CC0' },
    { url: 'https://cdn.freesound.org/previews/573/573187_97550-lq.mp3#voima=0.38', nimi: 'Kirkas rantahyöky — TRP, CC0' },
    { url: 'https://cdn.freesound.org/previews/543/543819_6667441-lq.mp3#voima=0.52', nimi: 'Isot aallot kivikkorannalla — Profispiesser, CC0' },
    { url: 'https://cdn.freesound.org/previews/570/570907_11519060-lq.mp3#voima=0.53', nimi: 'Laivan kansi merellä — bruno.auzet, CC0' },
  ],
  sademetsa: [
    { url: 'https://cdn.freesound.org/previews/818/818589_15983207-lq.mp3#voima=0.18', nimi: 'Viidakko ja apinat — AlaskanMariner, CC BY' },
    { url: 'https://archive.org/download/aporee_40377_46111/rs12.mp3#voima=0.25', nimi: 'Linnut metsässä (Thuin) — Vincent Duseigne, CC BY' },
    { url: 'https://cdn.freesound.org/previews/410/410078_1661766-lq.mp3#voima=0.16', nimi: 'Yösade ja ukkonen sademetsässä — felix.blume, CC0' },
    { url: 'https://cdn.freesound.org/previews/407/407583_1661766-lq.mp3#voima=0.18', nimi: 'Sademetsän linnut — felix.blume, CC0' },
    { url: 'https://cdn.freesound.org/previews/253/253301_2409224-lq.mp3#voima=0.34', nimi: 'Viidakon yö (Borneo) — RTB45, CC BY' },
    { url: 'https://cdn.freesound.org/previews/486/486437_7266967-lq.mp3#voima=0.81', nimi: 'Yösirkat viidakossa — FreeToUseSounds, CC BY' },
  ],
  savanni: [
    { url: 'https://cdn.freesound.org/previews/202/202876_1934171-lq.mp3#voima=1.76', nimi: 'Savannin yösirkat — AugustSandberg, CC0' },
    // Omistajan huomio: klipin alku on vaimea — esitäytetty alkukohta 20 s.
    { url: 'https://cdn.freesound.org/previews/714/714271_14696146-lq.mp3#voima=0.7', nimi: 'Kuiva tuulinen maisema — Metris, CC BY', alku: 20 },
    { url: 'https://cdn.freesound.org/previews/504/504694_778707-lq.mp3#voima=1.7', nimi: 'Masai-leirin luontoäänet — selcukartut, CC0' },
    { url: 'https://cdn.freesound.org/previews/612/612318_13563349-lq.mp3#voima=0.21', nimi: 'Virtahevot joella (Kruger) — noisymichael, CC BY' },
    { url: 'https://cdn.freesound.org/previews/764/764981_15688695-lq.mp3#voima=0.61', nimi: 'Sirkat yöllä (Etelä-Afrikka) — Christian.Combrinck, CC0' },
    { url: 'https://cdn.freesound.org/previews/411/411996_7037-lq.mp3#voima=0.65', nimi: 'Ukkosmyrsky Etelä-Afrikassa — tim.kahn, CC BY-NC' },
  ],
  ylanko: [
    { url: 'https://archive.org/download/aporee_68991_80056/almaporeejochbergalm12uhr30.mp3#voima=0.34', nimi: 'Alppilaidun (Reit im Winkl, Baijeri) — sam auinger, CC BY-SA' },
    { url: 'https://cdn.freesound.org/previews/543/543449_3377875-lq.mp3#voima=0.16', nimi: 'Ulvova tuuli — Kostas17, CC BY' },
  ],
   ...
   */
  kaupunki: [
    { url: 'https://cdn.freesound.org/previews/723/723081_2978883-lq.mp3#voima=0.39', nimi: 'Kaupungin yö — rucisko, CC BY-NC' },
    { url: 'https://cdn.freesound.org/previews/677/677253_9756914-lq.mp3#voima=0.33', nimi: 'Piha illalla — LaureC, CC0' },
    { url: 'https://cdn.freesound.org/previews/511/511005_571436-lq.mp3#voima=0.87', nimi: 'Kaupungin hälinä — 3bagbrew, CC0' },
  ],
  satama: [
    { url: 'https://archive.org/download/aporee_8703_10524/CityCountryMeSassnitzFischereihafenFender.mp3#voima=0.24', nimi: 'Kalasatama (Sassnitz) — henrik schröder, CC BY-SA' },
    { url: 'https://cdn.freesound.org/previews/570/570907_11519060-lq.mp3#voima=0.53', nimi: 'Laivan kansi merellä — bruno.auzet, CC0' },
...
export const EHDOKKAAT = {
  ...
  'musiikki:tietovisa': {
    ...
    oletus: 'https://cdn.freesound.org/previews/176/176134_334810-lq.mp3#voima=0.23',
    ehdokkaat: [
      { url: 'https://cdn.freesound.org/previews/176/176134_334810-lq.mp3#voima=0.23', nimi: '6_drums_luangprabang.WAV — LukeIRL, CC BY' },
      { url: 'https://cdn.freesound.org/previews/713/713120_14632469-lq.mp3#voima=0.19', nimi: 'Arabialainen huilu — DYEKHO, CC0' },
      { url: 'https://cdn.freesound.org/previews/466/466570_197130-lq.mp3#voima=0.33', nimi: 'Kalimba-luuppi — CarlosCarty, CC BY' },
      ...
      { url: 'https://cdn.freesound.org/previews/557/557122_2282212-lq.mp3#voima=0.15', nimi: 'Tumma ambient-pinta — szegvari, CC0' },
    ],
  },
  ...
  'tehoste:dice': {
    otsikko: 'Noppa',
    oletus: 'https://cdn.freesound.org/previews/94/94031_1554038-lq.mp3#voima=0.19',
    ehdokkaat: [
      { url: 'https://cdn.freesound.org/previews/94/94031_1554038-lq.mp3#voima=0.19', nimi: 'Dice Roll — LoafDV, CC0' },
      { url: 'https://cdn.freesound.org/previews/535/535816_9613218-lq.mp3#voima=0.51', nimi: 'Dés — Lendewell, CC0' },
    ],
  },
  'tehoste:pen': {
    otsikko: 'Kirjoituskone (alkuteksti)',
    oletus: 'https://cdn.freesound.org/previews/856/856165_18901108-lq.mp3#voima=0.51',
    ehdokkaat: [
      { url: 'https://cdn.freesound.org/previews/856/856165_18901108-lq.mp3#voima=0.51', nimi: 'Yksittäinen näppäinlyönti — brktkrgll, CC0' },
      { url: 'https://cdn.freesound.org/previews/271/271525_4415905-lq.mp3#voima=0.74', nimi: 'Ylen arkiston Triumph Matura 1970-l. — YleArkisto, CC BY' },
      { url: 'https://cdn.freesound.org/previews/650/650986_3066717-lq.mp3#voima=0.38', nimi: 'Olympia 1956 — AchimEngels, CC0' },
      { url: 'https://cdn.freesound.org/previews/844/844137_2309965-lq.mp3#voima=3.31', nimi: 'Mekaaninen naputus — Alex_hears_things, CC0' },
      { url: 'https://cdn.freesound.org/previews/862/862556_12084000-lq.mp3#voima=0.61', nimi: 'L C Speed 1946 (naputus alkaa ~20 s) — ColinMWJones, CC0' },
    ],
  },
  'tehoste:jet': {
    otsikko: 'Lentokohtauksen moottori',
    // Omistajan valinta (31.7.): sama kuin sound.js:n REAL_SAMPLES.jet.
    oletus: 'https://cdn.freesound.org/previews/315/315660_2506497-lq.mp3#voima=0.17',
    ehdokkaat: [
      { url: 'https://cdn.freesound.org/previews/416/416891_2456794-lq.mp3#voima=0.15', nimi: 'Lentoonlähtö matkustamosta — Apheo, CC0' },
      { url: 'https://cdn.freesound.org/previews/845/845957_14269391-lq.mp3#voima=0.15', nimi: 'Nousu, matkustamo — ElevatorFan2020, CC0' },
      { url: 'https://cdn.freesound.org/previews/577/577480_97550-lq.mp3#voima=0.19', nimi: 'Pienkoneen jyrinä sisältä — TRP, CC0' },
      { url: 'https://cdn.freesound.org/previews/436/436942_843915-lq.mp3#voima=0.15', nimi: 'Matkalento sisältä — Filmscore, CC0' },
      { url: 'https://cdn.freesound.org/previews/315/315660_2506497-lq.mp3#voima=0.17', nimi: 'Potkurikoneen ylilento (ATR 72) — Hoscalegeek, CC0' },
      { url: 'https://cdn.freesound.org/previews/586/586106_11576705-lq.mp3#voima=0.41', nimi: 'Pienen potkurikoneen ohilento — LarsErikErtzgaardRingen, CC0' },
    ],
  },
  'tehoste:quizOpen': {
    otsikko: 'Kysymyksen avaus',
    oletus: 'https://cdn.freesound.org/previews/842/842183_13307919-lq.mp3#voima=3.07',
    ehdokkaat: [
      { url: 'https://cdn.freesound.org/previews/842/842183_13307919-lq.mp3#voima=3.07', nimi: 'Sivunkääntö — AardsReal, CC0' },
      { url: 'https://cdn.freesound.org/previews/165/165464_1956076-lq.mp3#voima=0.23', nimi: 'Harppukuvio — Puniho, CC BY' },
    ],
  },
...
const POISTETUT = new Set([
  'https://cdn.freesound.org/previews/160/160461_1-lq.mp3#voima=0.15',
]);
...
const OLETUSKORIT = {
  basaari: [
    'https://cdn.freesound.org/previews/723/723081_2978883-lq.mp3#voima=0.39',
    'https://cdn.freesound.org/previews/511/511005_571436-lq.mp3#voima=0.87',
  ],
  aavikko: [
    'https://cdn.freesound.org/previews/714/714271_14696146-lq.mp3#voima=0.7',
    'https://cdn.freesound.org/previews/411/411774_1910728-lq.mp3#voima=4.14',
    'https://cdn.freesound.org/previews/565/565015_12186594-lq.mp3#voima=0.15',
    'https://cdn.freesound.org/previews/635/635912_2247456-lq.mp3#voima=3.05',
    'https://cdn.freesound.org/previews/579/579250_2977885-lq.mp3#voima=0.19',
  ],
  meri: [
    'https://cdn.freesound.org/previews/848/848927_17398983-lq.mp3#voima=0.58',
    ...
    'https://cdn.freesound.org/previews/573/573187_97550-lq.mp3#voima=0.38',
    'https://cdn.freesound.org/previews/543/543819_6667441-lq.mp3#alku=22&voima=0.52',
    'https://cdn.freesound.org/previews/570/570907_11519060-lq.mp3#voima=0.53',
  ],
  sademetsa: [
    'https://cdn.freesound.org/previews/818/818589_15983207-lq.mp3#voima=0.18',
    'https://archive.org/download/aporee_40377_46111/rs12.mp3#voima=0.25',
    'https://cdn.freesound.org/previews/410/410078_1661766-lq.mp3#voima=0.16',
    'https://cdn.freesound.org/previews/407/407583_1661766-lq.mp3#voima=0.18',
    'https://cdn.freesound.org/previews/253/253301_2409224-lq.mp3#voima=0.34',
  ],
  savanni: [
    'https://cdn.freesound.org/previews/202/202876_1934171-lq.mp3#voima=1.76',
    'https://cdn.freesound.org/previews/714/714271_14696146-lq.mp3#alku=20&voima=0.7',
    'https://cdn.freesound.org/previews/504/504694_778707-lq.mp3#voima=1.7',
    'https://cdn.freesound.org/previews/612/612318_13563349-lq.mp3#voima=0.21',
    'https://cdn.freesound.org/previews/764/764981_15688695-lq.mp3#voima=0.61',
    'https://cdn.freesound.org/previews/411/411996_7037-lq.mp3#alku=52&voima=0.65',
  ],
  ylanko: [
    'https://cdn.freesound.org/previews/543/543449_3377875-lq.mp3#voima=0.16',
  ],
  kaupunki: [
    'https://cdn.freesound.org/previews/723/723081_2978883-lq.mp3#voima=0.39',
    'https://cdn.freesound.org/previews/677/677253_9756914-lq.mp3#voima=0.33',
    'https://cdn.freesound.org/previews/511/511005_571436-lq.mp3#voima=0.87',
  ],
  satama: [
    'https://archive.org/download/aporee_8703_10524/CityCountryMeSassnitzFischereihafenFender.mp3#voima=0.24',
    'https://cdn.freesound.org/previews/570/570907_11519060-lq.mp3#voima=0.53',
    'https://cdn.freesound.org/previews/635/635103_10065335-lq.mp3#voima=0.15',
  ],
  vuoristo: [
    'https://archive.org/download/aporee_68991_80056/almaporeejochbergalm12uhr30.mp3#voima=0.34',
    'https://cdn.freesound.org/previews/543/543449_3377875-lq.mp3#voima=0.16',
  ],
  metsa: [
    'https://archive.org/download/aporee_40377_46111/rs12.mp3#voima=0.25',
...
export const KAUPUNKI_EHDOKKAAT = {
  europe: {
    lontoo: [
      { url: 'https://archive.org/download/aporee_5304_6751/AutumnDayStJamesparkLondon.mp3#voima=0.4',
        nimi: 'St James\'s Parkin syysiltapäivä — john grzinich, CC BY-SA' },
      { url: 'https://archive.org/download/aporee_37194_42604/20170721StJamessParkOpprearofDowningSt.mp3#voima=0.47',
        nimi: 'St James\'s Park Downing Streetin takana — Toby Cottrell, public domain' },
    ],
    istanbul: [
      { url: 'https://archive.org/download/aporee_8127_9900/tierebeiyenicami.mp3#voima=0.17',
        nimi: 'Lintutori — Adi W, CC BY-SA' },
      { url: 'https://archive.org/download/aporee_6217_7744/SundaysoundscapeTunel1640.mp3#voima=0.3',
        nimi: 'Tünelin äänimaisema sunnuntaina — john grzinich, CC BY-SA' },
    ],
    dublin: [
      { url: 'https://archive.org/download/aporee_18838_21851/StStephensGreenWorldListeningDay180713.mp3#voima=1.39',
    ...
    edinburgh: [
      { url: 'https://archive.org/download/aporee_31551_36245/22032016104pmhartstreetgardenschogarth.mp3#voima=1.05',
        nimi: 'Puutarhojen kastelua Hart Streetin takana — Felicity Ford, CC BY-SA' },
      { url: 'https://archive.org/download/aporee_31550_36244/220320161210pmgeorgeivparkblackbird.mp3#voima=0.51',
        nimi: 'Mustarastas George IV -puistossa — Felicity Ford, CC BY-SA' },
    ],
    pariisi: [
      { url: 'https://archive.org/download/aporee_8974_10822/parisruemontorgueil.mp3#voima=0.68',
        nimi: 'Rue Montorgueil — Adi W, CC BY-SA' },
    ],
    marseille: [
      { url: 'https://archive.org/download/aporee_40436_46176/201855QuaiduPortseafluxboatmurmur1737.mp3#voima=0.18',
        nimi: 'Vanha satama: veneiden narinaa ja puheensorinaa — OR poiesis, CC BY-NC-ND' },
    ],
    lissabon: [
      { url: 'https://archive.org/download/aporee_60580_69616/20160705004glisedeSantaLuisaPCMD100.mp3#voima=0.36',
        nimi: 'Praça Júlio de Castilho — Flavien Gillié, public domain' },
    ],
    madrid: [
      { url: 'https://archive.org/download/aporee_23518_27342/2014052405CentroCvicoTallerBrandonLabellePlazaCorralaPaseosonoroporinstalacinsillasdiariosoutwav.mp3#voima=0.24',
    ...
    granada: [
      { url: 'https://archive.org/download/aporee_61524_70763/230214020BPlazaNuevaPilardelToro.mp3#voima=0.35',
        nimi: 'Plaza de Santa Ana — Paz Tornero, CC BY-NC-ND' },
      { url: 'https://archive.org/download/aporee_61541_70780/230516002CatedralfrentealtarmasvolumenFadeAadido.mp3#voima=3.38',
        nimi: 'Plaza de las Pasiegas tuomiokirkon vieressä — Paz Tornero, CC BY-NC-ND' },
    ],
    amsterdam: [
      { url: 'https://archive.org/download/aporee_9337_11221/BInterieurtramAdam.mp3#voima=0.48',
        nimi: 'Raitiovaunu linjalla 1 — Thijs Geritz, CC BY-SA' },
      { url: 'https://archive.org/download/aporee_70257_81862/AmsterdamMarkenpleinWaterloopleinlopendBinaural.mp3#voima=1.52',
        nimi: 'Sadepäivä Waterloopleinille — Jillis Molenaar, public domain' },
    ],
    berliini: [
      { url: 'https://archive.org/download/aporee_54966_62839/Gitschnerstr.mp3#voima=0.2',
        nimi: 'Arkea Gitschiner Straßella — sam auinger, CC BY-SA' },
      { url: 'https://archive.org/download/aporee_2104_67340/berlinBuerkner9Hhof29102022.mp3#voima=0.95',
        nimi: 'Aamu takapihan ikkunasta, Bürknerstraße — udo noll, CC BY-SA' },
    ],
    praha: [
      { url: 'https://archive.org/download/aporee_5354_6805/karluvmost.mp3#voima=0.16',
        nimi: 'Kaarlensilta — milos, CC BY-SA' },
      { url: 'https://archive.org/download/aporee_14029_16351/svantonin.mp3#voima=0.26',
        nimi: 'Pyhän Antoniuksen kirkko Strossmayerin aukiolla — milos, public domain' },
    ],
    wien: [
      { url: 'https://archive.org/download/aporee_60623_69666/WienJosefStraussParkAmbient.mp3#voima=0.96',
        nimi: 'Josef-Straußin puiston ambienssi — chr_friess, public domain' },
      { url: 'https://archive.org/download/aporee_34815_40020/17012201Vienna1830.mp3#voima=2.19',
        nimi: 'Katusoittajia Stefaninkirkon edessä — damir.kustic, public domain' },
    ],
    budapest: [
      { url: 'https://archive.org/download/aporee_54374_62197/81BIBUDAPESZTTramtripFromArenatoKonyvesKalmankorut170122163550.mp3#voima=0.22',
        nimi: 'Raitiovaunumatka — Piotrek Zyla, public domain' },
    ],
    varsova: [
      { url: 'https://archive.org/download/aporee_71588_83518/2503101259.mp3#voima=0.3',
        nimi: 'Plac Zbawiciela, raitiovaunut ohittavat — Andrzej Maciejewski, CC BY-NC' },
      { url: 'https://archive.org/download/aporee_71577_83505/2503081558.mp3#voima=0.24',
        nimi: 'Leikkipuisto ja katu — Andrzej Maciejewski, CC BY-NC' },
    ],
    krakova: [
      { url: 'https://archive.org/download/aporee_71560_83484/2502221312.mp3#voima=0.25',
        nimi: 'Kahvila vanhassakaupungissa — Andrzej Maciejewski, CC BY-NC' },
      { url: 'https://archive.org/download/aporee_11573_13626/hejnal.mp3#voima=1.31',
        nimi: 'Suuri tori (Rynek Główny) — Anna Nacher, CC BY-SA' },
    ],
    alpit: [
      { url: 'https://archive.org/download/aporee_38136_43618/GlockenderKircheSanMaternoOrasso.mp3#voima=0.15',
        nimi: 'Orasson kirkonkellot — Fido, public domain' },
      { url: 'https://archive.org/download/aporee_10342_12318/06caviano.mp3#voima=1.85',
        nimi: 'Cavianon kujat, Ticino — maboart ja ursula bohren, CC BY-SA' },
    ],
    venetsia: [
      { url: 'https://archive.org/download/aporee_52547_60044/20180524PlaceSazintMarcr1session20210316.mp3#voima=0.48',
        nimi: 'Piazza San Marco: väkeä ja kelloja — Flavien Gillié, CC BY-NC-SA' },
      { url: 'https://archive.org/download/aporee_27844_32090/201556veniceNightWalk2246.mp3#voima=0.22',
        nimi: 'Yökävely Venetsian kujilla — OR poiesis, CC BY-SA' },
    ],
    rooma: [
      { url: 'https://archive.org/download/aporee_60994_70119/AMBUrbnStereoTreviFountainTuristsdifferentlangauagesaccordion.mp3#voima=0.19',
        nimi: 'Trevin lähde — Josue Amador, public domain' },
    ],
    sisilia: [
      { url: 'https://archive.org/download/aporee_13977_16297/bambino.mp3#voima=0.25',
        nimi: 'Vuohilauma ja paimenten huudot, Geraci Siculo — hatoriyumi, public domain' },
      { url: 'https://archive.org/download/aporee_61268_70466/AMBRoccazzelleSicilybeachpeoplewavesaugust.mp3#voima=2.29',
        nimi: 'Roccazzellen ranta — Andrea Gianessi, CC BY-NC-SA' },
    ],
    ateena: [
      { url: 'https://archive.org/download/aporee_30592_35195/hackny.mp3#voima=0.33',
        nimi: 'Lapsia ja hevosvaunu Dionysiou Areopagitoulla — maciej janasik, CC BY' },
      { url: 'https://archive.org/download/aporee_52826_60346/515ORTFATHENScityambientwithmusicfromFilopappouhillwestside190308001.mp3#voima=0.28',
        nimi: 'Kaupungin ääni Filopappoksen kukkulalta — Piotrek Zyla, public domain' },
    ],
    kreeta: [
      { url: 'https://archive.org/download/aporee_14962_17435/back.mp3#voima=0.37',
        nimi: 'Iraklionin sivukatu turistireitin ulkopuolella — maciej janasik, public domain' },
      { url: 'https://archive.org/download/aporee_14954_17425/wav.mp3#voima=0.33',
        nimi: 'Aallot Iraklionin venesataman laiturilla — maciej janasik, public domain' },
    ],
    dubrovnik: [
      { url: 'https://archive.org/download/aporee_69938_81439/AMBextclosecavewaterseamerwavemouvementbasseauCroatieDubrovnikdancebeachMAUMUS.mp3#voima=2.32',
        nimi: 'Aallot luolassa — maumus.nico, public domain' },
      { url: 'https://archive.org/download/aporee_59836_68692/wallsofdubrovnik.mp3#voima=1.71',
        nimi: 'Dubrovnikin muurit — Roberto Vodanović Čopor, public domain' },
    ],
    sarajevo: [
      { url: 'https://archive.org/download/aporee_72320_84455/stjosephchurchsarajevo.mp3#voima=0.23',
        nimi: 'Baščaršijan äänimaisema — Haris Sahačić, public domain' },
    ],
    sofia: [
      { url: 'https://archive.org/download/aporee_15487_18036/LS111000kopor.mp3#voima=0.15',
    ...
    bukarest: [
      { url: 'https://archive.org/download/aporee_63552_73145/992BIBUCHARESTchildrenplayinginIcoaneipark230505at1055.mp3#voima=0.42',
        nimi: 'Lapsia Icoanein puistossa — Piotrek Zyla, public domain' },
    ],
    kiova: [
      { url: 'https://archive.org/download/aporee_41361_47183/upload20180928140034.mp3#voima=1.4',
        nimi: 'Lintuja ja katua puistossa — soundkovalsky, public domain' },
      { url: 'https://archive.org/download/aporee_41362_47184/upload20180928142313.mp3#voima=0.88',
    ...
    moskova: [
      { url: 'https://archive.org/download/aporee_2952_4003/RoterPlatz.mp3#voima=0.15',
        nimi: 'Punainen tori — botsch, CC BY-SA' },
      { url: 'https://archive.org/download/aporee_47375_53831/200127004.mp3#voima=0.76',
        nimi: 'Donskajan aukio — val.trubin, public domain' },
    ],
    pietari: [
      { url: 'https://archive.org/download/aporee_69929_81429/ambienceatmosphereofeveningcitystreetnearnoisyavenue.mp3#voima=0.37',
        nimi: 'Iltakatu keskustassa — albert.mail, public domain' },
      { url: 'https://archive.org/download/aporee_39420_45057/B1.mp3#voima=0.15',
        nimi: 'Sennajan aukio — yakovlurie, public domain' },
    ],
    helsinki: [
      { url: 'https://archive.org/download/aporee_13153_15385/11081005HelsinkiKauppatori171216bit224.mp3#voima=1.57',
        nimi: 'Kauppatori — damir.kustic, public domain' },
    ],
    tallinna: [
      { url: 'https://archive.org/download/aporee_46851_53197/AsonicwalkanddeeplisteningtoKalamaja1.mp3#voima=4.07',
        nimi: 'Kalamajan puisto, hidas kävely — bruno.quast, public domain' },
      { url: 'https://archive.org/download/aporee_10868_12873/tallinnKopliMaratiPark110707b.mp3#voima=0.64',
        nimi: 'Koplin puisto — udo noll, CC BY-SA' },
    ],
    riika: [
      { url: 'https://archive.org/download/aporee_57929_66350/rigachanelunderwater.mp3#voima=1.22',
        nimi: 'Kanaali — alas23/sala, public domain' },
      { url: 'https://archive.org/download/aporee_57927_66348/rigacenterwalk2030.mp3#voima=0.84',
        nimi: 'Iltakävely — alas23/sala, public domain' },
    ],
    vilna: [
      { url: 'https://archive.org/download/aporee_53389_61000/SokantisFontanas.mp3#voima=0.15',
        nimi: 'Tanssiva suihkulähde puistossa — Marius Paulikas, public domain' },
      { url: 'https://archive.org/download/aporee_9230_11102/vilnius1.mp3#voima=0.29',
        nimi: 'Linnut kaupungin melussa — alas23/sala, CC BY-SA' },
    ],
    tukholma: [
      { url: 'https://archive.org/download/aporee_33112_38049/StockholmdesdepontKlarastrandsleden.mp3#voima=0.23',
        nimi: 'Junat, autot ja vesi Norrmalmissa — Albert Murillo, CC BY' },
      { url: 'https://archive.org/download/aporee_33214_38190/StockholmplaaHtorgetmercatdeflors.mp3#voima=0.38',
        nimi: 'Kukkatori Norrmalmissa — Albert Murillo, CC BY' },
    ],
    oslo: [
      { url: 'https://archive.org/download/aporee_45891_52120/carillondiOslo.mp3#voima=0.37',
        nimi: 'Kaupungintalon kellopeli — saveriodecian, public domain' },
      { url: 'https://archive.org/download/aporee_19365_22488/LS111550park.mp3#voima=1.26',
    ...
    lappi: [
      { url: 'https://archive.org/download/aporee_32161_36945/patrickmcginley20160505kemijokibridge.mp3#voima=0.16',
        nimi: 'Kemijoen ranta sillan alla, Rovaniemi — patrick mcginley, CC BY-NC-SA' },
    ],
    tromssa: [
      { url: 'https://archive.org/download/aporee_65563_75724/Harbour20241014174716.mp3#voima=0.58',
        nimi: 'Sataman ponttoni narisee — anguscarlyle, public domain' },
      { url: 'https://archive.org/download/aporee_65153_75248/AmundsenPark.mp3#voima=0.65',
        nimi: 'Roald Amundsenin aukion puisto — anguscarlyle, public domain' },
    ],
    islanti: [
      { url: 'https://archive.org/download/aporee_1475_2022/neoscenes0924074birdstreet2is.mp3#voima=0.17',
        nimi: 'Lintu kadun varrella — John Hopkins, CC BY-SA' },
      { url: 'https://archive.org/download/aporee_61946_71274/231021Trollafoss.mp3#voima=0.15',
