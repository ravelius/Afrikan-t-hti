...
export const AFRICA_QUESTIONS = {
  ...
  claims: [
    ...
    },
    {
      ...
      correct: true,
      fact: 'Atbara on yhä Niilin viimeinen sivujoki. Siitä eteenpäin joki virtaa yli 2 000 kilometriä Välimereen ilman yhtään lisäjokea ja menettää matkalla vettä haihtumiseen ja kasteluun. Assuanissa sataa vuodessa keskimäärin alle millimetri.',
    },
    {
    ...
    },
    {
      ...
      correct: true,
      fact: 'Taoudennin kaivoksilla Pohjois-Malissa suola hakataan yhä käsin laatoiksi, ja karavaani kulkee noin 700 kilometriä Timbuktuun parissa viikossa. Kuorma-autot vievät nykyään suurimman osan kuormasta ja alueen levottomuudet ovat katkoneet reittiä, mutta kamelikaravaanit kulkevat yhä.',
    },
    {
    ...
    },
    {
      ...
      correct: true,
      fact: 'Kapkaupungissa on välimerellinen ilmasto: sateet tulevat talvella touko–elokuussa ja kesä on kuiva. Juuri siksi kaupunki oli 2018 lähellä päivää, jona hanat olisi suljettu; asukkaita rajoitettiin viiteenkymmeneen litraan vuorokaudessa, ja tilanne helpotti vasta talvisateiden myötä.',
    },
    {
    ...
    },
    {
      ...
      correct: false,
      fact: 'Merikaapeli ylsi Etelä-Afrikkaan jo 1879, kuusi vuotta tämän merkinnän jälkeen. Nykyään mannerta kiertää useita valokuitukaapeleita — 2Africa on niistä pisin, noin 45 000 kilometriä — ja viesti kulkee Kapkaupungista Lontooseen sekunnin murto-osassa.',
    },
    {
    ...
    },
    {
      ...
      correct: false,
      fact: 'Yli viisitoista Afrikan maata on lähettänyt oman satelliittinsa kiertoradalle: Egyptin Nilesat 101 vuonna 1998 ja Etelä-Afrikan itse rakentama SUNSAT 1999. Afrikan avaruusvirasto avattiin Kairossa 2025, ja Nairobissa toimiva kartoituskeskus RCMRD tuottaa aineistoa kahdellekymmenelle jäsenmaalleen.',
    },
    {
      ...
      correct: false,
      fact: 'Afrikassa on nykyään noin neljäkymmentä valuuttaa — muun muassa naira, cedi, randi, birr, shillinki ja dirhami — sekä neljäntoista maan yhteinen CFA-frangi. Punnalla saa vaihtokonttorista paikallista rahaa aivan kuten millä tahansa ulkomaan setelillä.',
    },
  ],
};
